...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar el nombre del pais del jugador ");
	}
	...
	{
		String Nombre = input("Por favor ingrese el nombre del jugador");
		Atleta N= calculadora.buscarPais_Jugador(Nombre);
		System.out.println("El jugador "+N.darNombre()+"es del pais:"+(N.darPais().darNombre()));
