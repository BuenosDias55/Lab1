...
public class CalculadoraEstadisticas
{
	...
	public 	Map<String, Object> BuscarAtletaporPais(String nombrePais)
	{
		Map<String, Object> resultado = new HashMap<String, Object>();
		for (Atleta unatleta:atletas)
		{
			if (unatleta.darNombre().equals(nombrePais))
			{
	...
	/**
	 * Laboratorio numero 1 donde se le pde al usuario que ingrese el nombre de un jugador y le devuelva el pais
	 */
	public Atleta buscarPais_Jugador(String Nombre)
	{
		
		Atleta N=buscarAtleta(Nombre);
